            ...
            if (years && years.length > 0) {
                ...
                for (let i = 0; i < years.length; i++) {
                    ...
                    for (let m = 1; m <= 12; m++) {
                        ...
                        // Bolt Optimization: Parallelize independent monthly chunks to improve performance
                        // while keeping month-over-month sequential to prevent database locking/CPU spikes.
                        updateStatus(`Processando ${m}/${year} (Chunks 1-3)...`, progress + Math.round(monthStep * 0.20));
                        await Promise.all([
