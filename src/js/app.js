...
let jbpTrendInfo = { allowed: false, factor: 1, month_index: 11 };
     ...
     * 🧹 Tidy Optimization: This wrapper simplifies calls that pass empty functions `() => {}` to `setupMultiSelect`, reducing repetitive boilerplate and improving code readability.
     */
