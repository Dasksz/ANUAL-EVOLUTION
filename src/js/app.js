...
import { setEstrelasDetailedData } from "./modals.js";
import { initCityDashboard } from "./cityDashboard.js";
...
let estrelasSelectedCategorias = [];
    ...
    const cityDashboard = initCityDashboard();
    const { loadCityView, initCityFilters, state: cityState } = cityDashboard;
    ...
    function getFiltersFromActiveView() {
        ...
        if (view === 'dashboard') {
            ...
            state.vendedores = cityState.citySelectedVendedores;
            state.fornecedores = cityState.citySelectedFornecedores;
            state.tiposvenda = cityState.citySelectedTiposVenda;
            state.redes = cityState.citySelectedRedes;
        } else if (view === 'boxes') {
...
async function updateEstrelasView() {
    ...
    try {
        ...
        setEstrelasDetailedData(data.detalhes, data.aceleradores_qtd_marcas);
