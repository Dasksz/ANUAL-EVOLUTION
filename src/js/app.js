...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Global State Variables (Hoisted) ---
    let checkProfileLock = false;
    let isAppReady = false;
    let mainChartRoot = null;
    ...
    async function loadMainDashboardData(forceRefresh = false) {
        console.log("loadMainDashboardData called");
        const filters = getCurrentFilters();
        const cacheKey = generateCacheKey('dashboard_data', filters);
    ...
    function renderMainChartAmCharts(data) {
        console.log("renderMainChartAmCharts called", data);
        if (mainChartRoot) {
