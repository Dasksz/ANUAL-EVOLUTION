-- Fix for Product Filter Logic (Bug: Selecting KEROCOCO shows all 1119 products)
-- This script updates the get_dashboard_filters function to strictly filter products by description
-- when specific 1119 subtypes (KEROCOCO, QUAKER, TODDY, etc.) are selected.
